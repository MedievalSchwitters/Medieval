...
export class TreeComponent {
  ...
  public myDiagramComponent: DiagramComponent | null = null;
  @ViewChild('myPalette', { static: true })
  public myPaletteComponent: PaletteComponent | null = null;
    ...
    this.diagram.nodeTemplate = $(
      ...
      $(
        ...
        $(
          ...
          $(
            go.TextBlock,
            { font: 'bold 17pt arial', stroke: 'white' }, // the name
            {
              row: 0,
              column: 0,
              columnSpan: 5,
  ...
  resizeDiagram() {
    ...
    this.diagram!.div!.style.width = (
      this.diagram.div!.parentElement!.clientWidth + 2
    ).toString();
    this.diagram!.div!.style.height = '2';
    this.diagram!.div!.style.height = (
      this.diagram.div!.parentElement!.offsetHeight + 2
    ).toString();
  }
}
